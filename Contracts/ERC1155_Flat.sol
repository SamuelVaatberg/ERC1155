 ...
 */
contract FinalContract is ERC1155Tradable {
  ...
  ERC1155Tradable(
    ...
    _symbol,                                //Ticker
    _proxyRegistryAddress                   //Address of creator
  ) public {
    _setBaseMetadataURI(_metadataUri);      //Link to JSON metadata for IDs  
    _setContractURI(_contractUri);          //Link to JSON metadata for contract
  }
